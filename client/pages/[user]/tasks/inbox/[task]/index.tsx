...
const Index = ({revision, user, serverHost}) => {
            ...
            <Stack direction={"column"} spacing={2} sx={{
                ...
                <Stack direction="row" spacing={2}>
                    ...
                    <Button size="small" variant="contained" onClick={() => {                      
                        axios.delete(`${serverHost}user/${revision.signer}/taskInBox`, revision = {...revision})
                            .then (() => {
...
export const getServerSideProps: GetServerSideProps = async ({params}) => {
    ...
    const resTask = await axios.get (process.env.SERVER_HOST + 'task/revision/' + params.task)
    const resUser = await axios.get (process.env.SERVER_HOST + 'user/' + params.user);
    return {
        props: {
            revision: resTask.data,
            user: resUser.data,
